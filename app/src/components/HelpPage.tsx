    ...
    <div className="help-page">
      ...
      <div id="help-page-content" className="help-page-content">
        <button
          ...
          onClick={() => props.onToggleHelp(false)}>
        </button>
        ...
        <div className="help-page-cards">
          <div className="card">
            ...
            <div id="collapseIntro" className="collapse show"
                 aria-labelledby="headingIntro" data-parent="#help-page-content">
          ...
          <div className="card">
            ...
            <div id="collapseUsage" className="collapse"
              ...
              <div className="card-body">
                ...
                <p className="card-text">
                  Zooming and panning are available using the default methods of the display device,
                  eg. pinching on a tablet.
                </p>
                <p className="card-text">
                  <em>Double-Clicking</em> an interval will expand it, making it the central parent
                  of the other child intervals displayed. Only those intervals with child-intervals
                  can be expanded, eg. the Archaen can be navigated into while the Hadean cannot.
                </p>
                <p className="card-text">
                ...
                <p className="card-text">
                  A <em>Double-Click</em> on any subject in the timeline visualization will attempt to
                  present it in the most accurate geological interval according to the subject's date
                  range. If the subject happens to cross boundaries then this can result in the
                  geological interval being the base &quot;Geological Timescale&quot;.
                </p>
                <p className="card-text">
                  Click the menu button on the timeline visual to display the labels of the
                  subjects&apos; category. Subjects belonging to these categories can be filtered out
                  of the timeline visual by clicking each of these labels. The subjects can be restored
                  with a second click. This filtering is maintained while clicking on subjects or on
                  geolical intervals.
                </p>
                <p className="card-text">
                  A Search box is available for finding any intervals, subjects or descriptions by
                  keyword. A slide-in pane will display the search results and a
                  <em>Single-Click</em> will navigate to the target in the visuals.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="card">
            ...
            <div id="collapseAck" className="collapse"
                 aria-labelledby="headerAck" data-parent="#help-page-content">
              <div className="card-body">
                <p className="card-text">
          ...
          <div className="card">
            ...
            <div id="collapseContrib" className="collapse"
                 aria-labelledby="headerContrib" data-parent="#help-page-content">
              <div className="card-body">
                <p className="card-text">
                  The source code and data for this project is available
                  on <a href="https://github.com/phantomjinx/evotempus">github</a> and licensed
                  under the <a href="https://github.com/phantomjinx/evotempus/blob/master/LICENSE">GPLv3</a>.
                </p>
                <p className="card-text">
                  Additional licences for components used in this work are available from the
                  project <a href="https://github.com/phantomjinx/evotempus/tree/master/Licences">here</a>.
                </p>
                <p className="card-text">
                  If you find a bug or would like to add some data points then please do not hesitate
                  to file an issue or post a pull-request.
                </p>
